        ...
        <header className="bg-transparent text-white  px-6 py-4 flex items-center justify-between shadow-md">
            <div className="flex items-center gap-4">
                ...
                >
                    ...
                    {isMegaMenuOpen && (
                        <div className="absolute top-10 left-0 z-50 bg-zinc-900 p-4 rounded-xl shadow-lg w-[750px] grid grid-cols-3 gap-2 border-4 border-white/10 ">
                            <div className="flex flex-col gap-0 h-full justify-between">
                                <MenuItem name="All" count="" icon="📖" />
            ...
            <div className="flex gap-4">
                <button className="bg-gradient-to-r from-purple-500 to-blue-500 px-4 py-1.5 rounded text-white font-semibold">+ Create</button>
...
function MenuItem({ name, count, icon }) {
    return (
        <div className="flex justify-between items-center px-4 py-3 bg-zinc-800 rounded-lg hover:bg-zinc-700 cursor-pointer">
