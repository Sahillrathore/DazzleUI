...
//   if (!isOpen) return null; // don't render when closed
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-xl bg-gradient-to-b from-[#2b2b62] via-[#1a1a1a] to-[#1a1a1a] rounded-2xl shadow-xl p-6 sm:p-8 overflow-hidden text-white"
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 w-full">
          ...
          <button
            className="w-2/3 flex items-center justify-center gap-2 bg-[#1f1f1f] hover:bg-[#2a2a2a] text-white py-2 rounded-md text-sm font-medium transition"
